...
try {
    ...
    Assert(InStr(voice.ui.xaml, 'Name="KwChipHost"') && InStr(voice.ui.xaml, 'Height="80"') && InStr(voice.ui.xaml, 'Name="KwChipPanel"') && InStr(voice.ui.xaml, 'Uid="ahk:Voice.Keywords.Chips"'), "voice chips sit in an 80px bordered scroller")
